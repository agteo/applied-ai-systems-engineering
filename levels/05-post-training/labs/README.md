# Level 05: Post-training labs

| Lab | Objective |
| --- | --- |
| [Lab 1: Training Decision](lab-01-training-decision.md) | Decide whether training is justified, from counts rather than intuition. |
| [Lab 2: Prepare SFT Data](lab-02-prepare-sft-data.md) | Export training data where every admitted row is one you would want the model to imitate, and every refusal is logged. |
